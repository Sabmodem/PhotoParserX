        ...
        const applyCustomClass = (elem, params, className) => {
          ...
          if (params.customClass && params.customClass[className]) {
            if (typeof params.customClass[className] !== "string" && !params.customClass[className].forEach) {
              warn4(`Invalid type of customClass.${className}! Expected string or iterable object, got "${typeof params.customClass[className]}"`);
              return;
            }
...
`.replace(/(^|\n)\s*/g, "");
        ...
        function handlePositionParam(container, position) {
          if (position in swalClasses) {
            ...
            warn4('The "position" parameter is not valid, defaulting to "center"');
        ...
        const checkAndSetInputValue = (input, inputValue) => {
          if (["string", "number"].includes(typeof inputValue)) {
            ...
            warn4(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof inputValue}"`);
          }
        };
...
`;
        ...
        const renderProgressSteps = (instance, params) => {
          ...
          if (params.currentProgressStep >= params.progressSteps.length) {
            warn4("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)");
          }
        ...
        const checkIfParamIsValid = (param) => {
          if (!isValidParameter(param)) {
            warn4(`Unknown parameter "${param}"`);
          }
        };
        const checkIfToastParamIsValid = (param) => {
          if (toastIncompatibleParams.includes(param)) {
            warn4(`The parameter "${param}" is incompatible with toasts`);
          }
        };
        ...
        const showWarningsForParams = (params) => {
          if (params.backdrop === false && params.allowOutsideClick) {
            warn4('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
          }
        ...
        function update(params) {
          ...
          if (!popup || hasClass(popup, innerParams.hideClass.popup)) {
            warn4(`You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.`);
            return;
          }
          const validUpdatableParams = filterValidParams(params);
          const updatedParams = Object.assign({}, innerParams, validUpdatableParams);
          render8(this, updatedParams);
        ...
        const filterValidParams = (params) => {
          ...
          Object.keys(params).forEach((param) => {
            if (isUpdatableParameter(param)) {
              ...
              warn4(`Invalid parameter to update: ${param}`);
            }
          });
        ...
        const showWarningsForElements = (templateContent) => {
          ...
          Array.from(templateContent.children).forEach((el) => {
            ...
            if (!allowedElements.includes(tagName)) {
              warn4(`Unrecognized element <${tagName}>`);
            }
          });
        };
        const showWarningsForAttributes = (el, allowedAttributes) => {
          Array.from(el.attributes).forEach((attribute) => {
            if (allowedAttributes.indexOf(attribute.name) === -1) {
              warn4([`Unrecognized attribute "${attribute.name}" on <${el.tagName.toLowerCase()}>.`, `${allowedAttributes.length ? `Allowed attributes are: ${allowedAttributes.join(", ")}` : "To set the value, use HTML within the element."}`]);
            }
          });
        };
        ...
        function validateCustomTargetElement(params) {
          if (!params.target || typeof params.target === "string" && !document.querySelector(params.target) || typeof params.target !== "string" && !params.target.appendChild) {
            warn4('Target parameter is not valid, defaulting to "body"');
            params.target = "body";
          }
        }
        function setParameters(params) {
          ...
          if (params.showLoaderOnConfirm && !params.preConfirm) {
            warn4("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request");
          }
        ...
        class SweetAlert {
          ...
          _main(userParams) {
            ...
            render8(currentInstance2, innerParams);
  ...
  var require_bootstrap = __commonJS({
    "src/assets/bootstrap/js/bootstrap.js"(exports, module) {
      (function(global2, factory) {
        ...
        class Dropdown extends BaseComponent {
          ...
          show() {
            ...
            if ("ontouchstart" in document.documentElement && !parent.closest(SELECTOR_NAVBAR_NAV)) {
              [].concat(...document.body.children).forEach((elem) => EventHandler.on(elem, "mouseover", noop3));
            }
            this._element.focus();
          ...
          _completeHide(relatedTarget) {
            ...
            if ("ontouchstart" in document.documentElement) {
              [].concat(...document.body.children).forEach((elem) => EventHandler.off(elem, "mouseover", noop3));
            }
            if (this._popper) {
              this._popper.destroy();
            }
        ...
        class Tooltip extends BaseComponent {
          ...
          hide() {
            ...
            if ("ontouchstart" in document.documentElement) {
              [].concat(...document.body.children).forEach((element) => EventHandler.off(element, "mouseover", noop3));
            }
    ...
    try {
      if (vnode.shapeFlag & 4) {
        ...
        result = normalizeVNode(render9.length > 1 ? render9(props, true ? {
          ...
          slots,
          emit: emit2
        } : { attrs, slots, emit: emit2 }) : render9(
          props,
          null
...
. If you are returning a value instead of calling "next", make sure to remove the "next" parameter from your function.`;
  ...
  function useLink(props) {
    ...
    const route = computed2(() => router2.resolve(unref(props.to)));
    ...
    function resolve2(rawLocation, currentLocation) {
      ...
      if ("path" in rawLocation) {
        ...
        Object.keys(rawLocation.params).length) {
          warn3(`Path "${// @ts-expect-error: the type is never
...
${JSON.stringify(newTargetLocation, null, 2)}
 when navigating to "${to.fullPath}". A redirect must contain a name or path. This will break in production.`);
  ...
  // src/emitter.js
  var emitter_default = mitt_default();

  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/App.vue?type=script
  ...
  var __default__ = {
    ...
    async created() {
      ...
      socket.onerror = () => {
        import_sweetalert2.default.fire({ title: "\u041E\u0448\u0438\u0431\u043A\u0430", text: "\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u043E\u0434\u043A\u043B\u044E\u0447\u0435\u043D\u0438\u044F \u043A \u0441\u0435\u0440\u0432\u0435\u0440\u0443 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0439. \u041F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0443 \u0438\u043B\u0438 \u043F\u0435\u0440\u0435\u0437\u0430\u043F\u0443\u0441\u0442\u0438\u0442\u044C \u0441\u043E\u0444\u0442, \u0435\u0441\u043B\u0438 \u043F\u0440\u043E\u0431\u043B\u0435\u043C\u0430 \u043D\u0435 \u0443\u0439\u0434\u0435\u0442", type: "error", confirmButtonText: "\u041E\u043A" });
      };
      socket.onmessage = async (event) => {
        const data = JSON.parse(event.data);
        const query_data = await axios_default.get(`/history/${data.id}`);
        emitter_default.emit("updateStatus", { id: data.id });
  ...
  var App_default = /* @__PURE__ */ Object.assign(__default__, {
    __name: "App",
    setup(__props, { expose }) {
      expose();
      const __returned__ = { get axios() {
        return axios_default;
      }, get emitter() {
        return emitter_default;
      }, get Swal() {
        return import_sweetalert2.default;
      }, get RouterLink() {
        return RouterLink;
      }, get RouterView() {
        return RouterView;
  ...
  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/App.vue?type=template
  var _hoisted_1 = { class: "navbar navbar-expand-lg navbar-light bg-light" };
  ...
  var _hoisted_5 = { class: "navbar-nav mr-auto" };
  var _hoisted_6 = { class: "nav-item active" };
  ...
  var _hoisted_10 = { class: "nav-item" };
  ...
  var langs_default = {
    ...
    "Catal\xE0 - ca-ES": "ca-ES",
    "Dansk - da-DK": "da-DK",
    "Deutsch - de": "de",
    "Deutsch (\xD6sterreich) - de-AT": "de-AT",
    ...
    "Espa\xF1ol - es": "es",
    "Espa\xF1ol (Argentina) - es-AR": "es-AR",
    "Espa\xF1ol (Chile) - es-CL": "es-CL",
    "Espa\xF1ol (Espa\xF1a) - es-ES": "es-ES",
    "Espa\xF1ol (M\xE9xico) - es-MX": "es-MX",
    "Fran\xE7ais - fr": "fr",
    "Fran\xE7ais (Belgique) - fr-BE": "fr-BE",
    "Fran\xE7ais (Canada) - fr-CA": "fr-CA",
    "Fran\xE7ais (Suisse) - fr-CH": "fr-CH",
    "Fran\xE7ais (France) - fr-FR": "fr-FR",
    "Hrvatski - hr-HR": "hr-HR",
    "Indonesia - id-ID": "id-ID",
    "Italiano - it-IT": "it-IT",
    "Kiswahili - sw-TZ": "sw-TZ",
    "Latvie\u0161u - lv-LV": "lv-LV",
    "Lietuvi\u0173 - lt-LT": "lt-LT",
    "Magyar - hu-HU": "hu-HU",
    "Nederlands - nl": "nl",
    "Nederlands (Belgi\xEB) - nl-BE": "nl-BE",
    "Nederlands (Nederland) - nl-NL": "nl-NL",
    "Norsk Bokm\xE5l - nb-NO": "nb-NO",
    "Polski - pl-PL": "pl-PL",
    "Portugu\xEAs - pt": "pt",
    "Portugu\xEAs (Brasil) - pt-BR": "pt-BR",
    "Portugu\xEAs (Portugal) - pt-PT": "pt-PT",
    "Rom\xE2n\u0103 - ro-RO": "ro-RO",
    ...
    "T\xFCrk\xE7e - tr-TR": "tr-TR",
    "\xCDslenska - is-IS": "is-IS",
    "\u010Ce\u0161tina - cs-CZ": "cs-CZ",
    "\u0395\u03BB\u03BB\u03B7\u03BD\u03B9\u03BA\u03AC - el-GR": "el-GR",
    "\u0411\u0435\u043B\u0430\u0440\u0443\u0441\u043A\u0430\u044F - be-BY": "be-BY",
    ...
    "\u4E2D\u6587 - zh": "zh",
    "\u4E2D\u6587 (\u4E2D\u56FD) - zh-CN": "zh-CN",
    "\u4E2D\u6587 (\u4E2D\u570B\u9999\u6E2F\u7279\u5225\u884C\u653F\u5340) - zh-HK": "zh-HK",
    "\u4E2D\u6587 (\u53F0\u7063) - zh-TW": "zh-TW",
    "\u65E5\u672C\u8A9E - ja-JP": "ja-JP",
    "\uD55C\uAD6D\uC5B4 - ko-KR": "ko-KR"
  };

  // src/assets/times.json
  var times_default = {
    Anytime: "",
    "Last day": "day",
    "Last week": "week",
  ...
  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/search.vue?type=script
  var search_default = {
    data() {
      const timeouts = [];
    ...
    methods: {
      async search() {
        ...
        ;
        const imgs = await axios_default.post("/search", this.settings);
        this.imgs = imgs.data;
  ...
  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/search.vue?type=template
  var _hoisted_13 = { class: "d-flex flex-column h-100" };
  var _hoisted_22 = { class: "d-flex flex-column justify-content-center align-items-center h-100" };
  ...
  var _hoisted_42 = { class: "input-group" };
  var _hoisted_52 = { class: "input-group-btn" };
  var _hoisted_62 = /* @__PURE__ */ createBaseVNode(
    "i",
    { class: "bi bi-search" },
    null,
    -1
  ...
  var _hoisted_82 = /* @__PURE__ */ createBaseVNode(
    "i",
    { class: "bi bi-x-lg" },
    null,
    -1
  ...
  var _hoisted_102 = { class: "d-flex flex-row m-3" };
        ...
        createBaseVNode("div", _hoisted_42, [
          withDirectives(createBaseVNode(
            "input",
            {
              ...
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => this.settings.query = $event)
            },
            null,
            512
            /* NEED_PATCH */
          ), [
            [vModelText, this.settings.query]
          ]),
          createBaseVNode("div", _hoisted_52, [
            ...
            createBaseVNode("button", {
              class: "btn btn-outline-secondary",
              onClick: _cache[2] || (_cache[2] = ($event) => $options.clearQueryInput())
            }, _hoisted_92)
          ])
        ]),
        createBaseVNode("div", _hoisted_102, [
          withDirectives(createBaseVNode(
            "input",
            {
              ...
              type: "number",
              "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => this.settings.pagesCount = $event)
            },
            null,
            512
            /* NEED_PATCH */
          ), [
            [vModelText, this.settings.pagesCount]
          ]),
          withDirectives(createBaseVNode(
            "select",
            {
              class: "form-control m-3",
              "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => this.settings.language = $event)
            },
            [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList(Object.keys(this.langs), (lang) => {
                  return openBlock(), createElementBlock("option", {
                    value: this.langs[lang]
                  }, toDisplayString(lang), 9, _hoisted_112);
                }),
                256
                /* UNKEYED_FRAGMENT */
              ))
            ...
            [vModelSelect, this.settings.language]
          ]),
          withDirectives(createBaseVNode(
            "select",
            {
              class: "form-control m-3",
              "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => this.settings.time = $event)
            },
            [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList(Object.keys(this.times), (time) => {
                  return openBlock(), createElementBlock("option", {
                    value: this.times[time]
                  }, toDisplayString(time), 9, _hoisted_122);
                }),
                256
                /* UNKEYED_FRAGMENT */
              ))
            ...
            [vModelSelect, this.settings.time]
          ]),
          withDirectives(createBaseVNode(
            "select",
            {
              class: "form-control m-3",
              "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => this.settings.timeout = $event)
            },
            [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList(this.timeouts, (timeout) => {
                  return openBlock(), createElementBlock("option", {
                    value: timeout.timeout
                  }, toDisplayString(timeout.text), 9, _hoisted_132);
                }),
                256
                /* UNKEYED_FRAGMENT */
              ))
            ...
            [vModelSelect, this.settings.timeout]
          ])
        ])
      ])
    ]);
  ...
  search_default.render = render2;
  search_default.__file = "src/views/search.vue";
  var search_default2 = search_default;

  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/components/histItem.vue?type=script
  var import_sweetalert22 = __toESM(require_sweetalert2_all());
  var histItem_default = {
    data() {
      return {};
    },
    props: ["item", "index"],
    methods: {
      ...
      async deleteHistItem() {
        const result = await import_sweetalert22.default.fire({
          title: "\u0412\u044B \u0443\u0432\u0435\u0440\u0435\u043D\u044B, \u0447\u0442\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0434\u0430\u043D\u043D\u044B\u0435 \u044D\u0442\u043E\u0433\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0430?",
          showCancelButton: true,
          confirmButtonText: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C"
        });
        if (result.isConfirmed) {
          await axios_default.delete(`/history/${this.item.id}`);
          emitter_default.emit("deleteHistItem", { id: this.item.id });
          import_sweetalert22.default.fire("\u0414\u0430\u043D\u043D\u044B\u0435 \u0443\u0434\u0430\u043B\u0435\u043D\u044B", "", "success");
        }
        ;
      },
      async makeArchive() {
        await axios_default.post(`/archives`, { qid: this.item.id });
      ...
      async updateStatus() {
        const updatedItem = await axios_default.get(`/history/${this.item.id}`);
        this.item.status = updatedItem.data.status;
      }
    },
    async mounted() {
      emitter_default.on("updateStatus", async (data) => {
  ...
  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/components/histItem.vue?type=template
  var _hoisted_14 = { scope: "row" };
  var _hoisted_23 = { class: "d-flex flex-row" };
  var _hoisted_33 = {
    key: 0,
  ...
  var _hoisted_83 = /* @__PURE__ */ createBaseVNode(
    "i",
    { class: "bi bi-trash" },
    null,
    -1
  ...
  var _hoisted_113 = /* @__PURE__ */ createBaseVNode(
    "i",
    { class: "bi bi-list-task" },
    null,
    -1
  ...
  var _hoisted_142 = /* @__PURE__ */ createBaseVNode(
    "i",
  ...
  var _hoisted_17 = /* @__PURE__ */ createBaseVNode(
    "i",
  ...
  function render3(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("tr", null, [
      ...
      createBaseVNode(
        "td",
        null,
        toDisplayString($props.item.datetime),
        1
        /* TEXT */
      ),
      createBaseVNode(
        "td",
        null,
        toDisplayString($props.item.query_string),
        1
        /* TEXT */
      ),
      createBaseVNode("td", null, [
        createBaseVNode("div", _hoisted_23, [
          this.item.status.position % 2 != 0 ? (openBlock(), createElementBlock("div", _hoisted_33, _hoisted_53)) : (openBlock(), createElementBlock("div", _hoisted_63)),
          createTextVNode(
            " " + toDisplayString(this.item.status.description),
            1
            /* TEXT */
          )
        ])
      ...
      createBaseVNode("td", null, [
        createBaseVNode("button", {
          ...
          title: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C",
          disabled: this.item.status.position % 2 == 0,
          onClick: _cache[0] || (_cache[0] = ($event) => $options.deleteHistItem())
        }, _hoisted_93, 8, _hoisted_73),
        createBaseVNode("button", {
          class: "btn btn-primary",
          title: "\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B",
          disabled: this.item.status.position == 0,
          onClick: _cache[1] || (_cache[1] = ($event) => $options.openResults())
        }, _hoisted_123, 8, _hoisted_103),
        this.item.status.position <= 1 ? (openBlock(), createElementBlock("button", {
          key: 0,
          disabled: this.item.status.position == 0,
          class: "btn btn-primary",
          title: "\u0421\u0444\u043E\u0440\u043C\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0430\u0440\u0445\u0438\u0432 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u043E\u0432",
          onClick: _cache[2] || (_cache[2] = ($event) => $options.makeArchive())
        }, _hoisted_15, 8, _hoisted_133)) : createCommentVNode("v-if", true),
        this.item.status.position <= 3 && this.item.status.position >= 2 ? (openBlock(), createElementBlock("button", {
          key: 1,
          disabled: this.item.status.position != 3,
          class: "btn btn-primary",
          title: "\u0421\u043A\u0430\u0447\u0430\u0442\u044C \u0430\u0440\u0445\u0438\u0432 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u043E\u0432",
          onClick: _cache[3] || (_cache[3] = ($event) => $options.downloadArchive())
        }, _hoisted_18, 8, _hoisted_16)) : createCommentVNode("v-if", true)
      ])
    ]);
  }

  // src/components/histItem.vue
  histItem_default.render = render3;
  histItem_default.__file = "src/components/histItem.vue";
  var histItem_default2 = histItem_default;

  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/history.vue?type=script
  var __default__2 = {
    data() {
      return {
        loading: true,
    ...
    methods: {
      async loadPage(pageNum) {
        ...
        const historyItemsRes = await axios_default.get(`/history/${pageNum - 1}`);
        this.history = historyItemsRes.data;
      }
    },
    async mounted() {
      const pagesCountRes = await axios_default.get(`/history/pages`);
      this.pagesCount = pagesCountRes.data.pagesCount;
      this.itemsCount = pagesCountRes.data.itemsCount;
      await this.loadPage(1);
      this.loading = false;
      emitter_default.on("deleteHistItem", async () => {
        await this.loadPage(this.curPage);
      });
    }
  };
  var history_default = /* @__PURE__ */ Object.assign(__default__2, {
    __name: "history",
    setup(__props, { expose }) {
      expose();
      const __returned__ = { get axios() {
        ...
        return emitter_default;
      }, histItem: histItem_default2 };
      Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
      return __returned__;
    }
  });

  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/history.vue?type=template
  var _hoisted_19 = {
    key: 0,
    class: "spinner-border",
    role: "status"
  ...
  var _hoisted_44 = /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("tr", null, [
        ...
        /* @__PURE__ */ createBaseVNode("th", { scope: "col" }, "\u0414\u0430\u0442\u0430"),
        /* @__PURE__ */ createBaseVNode("th", { scope: "col" }, "\u0417\u0430\u043F\u0440\u043E\u0441"),
        /* @__PURE__ */ createBaseVNode("th", { scope: "col" }, "\u0421\u0442\u0430\u0442\u0443\u0441"),
        /* @__PURE__ */ createBaseVNode("th", { scope: "col" }, "\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u044F")
      ])
    ],
    -1
    /* HOISTED */
  );
  var _hoisted_54 = { class: "fixed-bottom d-flex justify-content-center" };
  var _hoisted_64 = {
    key: 2,
    class: "d-flex justify-content-center"
  };
  var _hoisted_74 = /* @__PURE__ */ createBaseVNode(
    "h1",
    null,
    "\u0412\u044B \u043F\u043E\u043A\u0430 \u043D\u0435 \u0441\u0434\u0435\u043B\u0430\u043B\u0438 \u043D\u0438 \u043E\u0434\u043D\u043E\u0433\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0430",
    -1
    /* HOISTED */
  );
  var _hoisted_84 = [
  ...
  function render4(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return openBlock(), createElementBlock(
      ...
      null,
      [
        this.loading ? (openBlock(), createElementBlock("div", _hoisted_19)) : createCommentVNode("v-if", true),
        this.history.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_24, [
          createBaseVNode("table", _hoisted_34, [
            ...
            createBaseVNode("tbody", null, [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList(this.history, (hi, index) => {
                  return openBlock(), createBlock($setup["histItem"], {
                    item: hi,
                    index
                  }, null, 8, ["item", "index"]);
                }),
          ...
          createBaseVNode("footer", _hoisted_54, [
            createVNode(_component_vue_awesome_paginate, {
              "total-items": this.itemsCount,
              "items-per-page": 10,
              "max-pages-shown": 5,
              modelValue: this.curPage,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => this.curPage = $event),
              "on-click": this.loadPage
            }, null, 8, ["total-items", "modelValue", "on-click"])
          ])
        ])) : createCommentVNode("v-if", true),
        this.history.length == 0 && !this.loading ? (openBlock(), createElementBlock("div", _hoisted_64, _hoisted_84)) : createCommentVNode("v-if", true)
      ],
      64
      /* STABLE_FRAGMENT */
    );
  ...
  history_default.render = render4;
  history_default.__file = "src/views/history.vue";
  var history_default2 = history_default;

  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/components/result.vue?type=script
  var result_default = {
    data() {
      return {};
    },
  ...
  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/components/result.vue?type=template
  var _hoisted_110 = { class: "row" };
  var _hoisted_25 = { class: "col-md-2" };
  var _hoisted_35 = ["src"];
  var _hoisted_45 = ["src"];
  var _hoisted_55 = { class: "col-md-10" };
  var _hoisted_65 = { class: "row" };
  var _hoisted_75 = {
    key: 0,
    class: "row"
  };
  var _hoisted_85 = /* @__PURE__ */ createBaseVNode(
    "div",
    { class: "col-md-2" },
    [
      /* @__PURE__ */ createBaseVNode("strong", null, "src:")
    ],
    -1
    /* HOISTED */
  );
  ...
  var _hoisted_114 = /* @__PURE__ */ createBaseVNode(
    "div",
    { class: "col-md-2" },
    [
      /* @__PURE__ */ createBaseVNode("strong", null, "thumb src:")
    ],
    -1
    /* HOISTED */
  );
  ...
  function render5(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_110, [
      createBaseVNode("div", _hoisted_25, [
        this.thumb_src ? (openBlock(), createElementBlock("img", {
          key: 0,
          class: "img-thumbnail",
          src: this.thumb_src
        }, null, 8, _hoisted_35)) : this.src ? (openBlock(), createElementBlock("img", {
          key: 1,
          class: "img-thumbnail",
          src: this.src
        }, null, 8, _hoisted_45)) : createCommentVNode("v-if", true)
      ]),
      createBaseVNode("div", _hoisted_55, [
        createBaseVNode("div", _hoisted_65, [
          this.src ? (openBlock(), createElementBlock("div", _hoisted_75, [
            _hoisted_85,
            createBaseVNode("a", {
              class: "col-md-10 text-truncate",
              href: this.src
            }, toDisplayString(this.src), 9, _hoisted_94)
          ])) : createCommentVNode("v-if", true),
          this.thumb_src ? (openBlock(), createElementBlock("div", _hoisted_104, [
            _hoisted_114,
            createBaseVNode("a", {
              class: "col-md-8 text-truncate",
              href: this.thumb_src
            }, toDisplayString(this.thumb_src), 9, _hoisted_124)
          ])) : createCommentVNode("v-if", true)
        ])
      ])
    ]);
  ...
  result_default.render = render5;
  result_default.__file = "src/components/result.vue";
  var result_default2 = result_default;

  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/results.vue?type=script
  var __default__3 = {
    data() {
      return {
        loading: true,
    ...
    methods: {
      async loadPage(pageNum) {
        this.curPage = pageNum;
        const resultsRes = await axios_default.get(`/results/${this.$route.params.id}/${pageNum - 1}`);
        this.results = resultsRes.data;
      }
    },
    async mounted() {
      const pagesCountRes = await axios_default.get(`/results/${this.$route.params.id}/pages`);
      this.pagesCount = pagesCountRes.data.pagesCount;
  ...
  var results_default = /* @__PURE__ */ Object.assign(__default__3, {
    __name: "results",
    setup(__props, { expose }) {
      expose();
      const __returned__ = { get axios() {
  ...
  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/results.vue?type=template
  var _hoisted_111 = {
    key: 0,
    class: "spinner-border",
    role: "status"
  ...
  var _hoisted_66 = { class: "fixed-bottom d-flex justify-content-center" };
  function render6(_ctx, _cache, $props, $setup, $data, $options) {
    const _component_vue_awesome_paginate = resolveComponent("vue-awesome-paginate");
    return openBlock(), createElementBlock("div", null, [
      this.loading ? (openBlock(), createElementBlock("div", _hoisted_111)) : createCommentVNode("v-if", true),
      !this.loading && this.results.length == 0 ? (openBlock(), createElementBlock("div", _hoisted_26, _hoisted_46)) : createCommentVNode("v-if", true),
      this.results.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_56, [
        (openBlock(true), createElementBlock(
          Fragment,
          null,
          renderList(this.results, (result) => {
            return openBlock(), createElementBlock("div", null, [
              createVNode($setup["result"], {
                src: result.img_src,
                thumb_src: result.thumb_src
              }, null, 8, ["src", "thumb_src"])
            ]);
          }),
          256
          /* UNKEYED_FRAGMENT */
  ...
  results_default.render = render6;
  results_default.__file = "src/views/results.vue";
  var results_default2 = results_default;

  // sfc-script:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/about.vue?type=script
  var about_default = {
    data() {
      return {};
    },
  ...
  // sfc-template:/home/sabmodem/soft/projects/python/photo-parser/project/src/views/about.vue?type=template
  var _hoisted_115 = { class: "container" };
  var _hoisted_27 = /* @__PURE__ */ createStaticVNode('<div class="d-flex justify-content-center"><h1>PhotoParserX</h1></div><div> PhotoParserX - \u042D\u0442\u043E \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430, \u043E\u0441\u043D\u043E\u0432\u043D\u043E\u0439 \u0446\u0435\u043B\u044C\u044E \u043A\u043E\u0442\u043E\u0440\u043E\u0439 \u044F\u0432\u043B\u044F\u0435\u0442\u0441\u044F \u043F\u043E\u0438\u0441\u043A \u0438 \u0441\u043A\u0430\u0447\u0438\u0432\u0430\u043D\u0438\u0435 \u043E\u0433\u0440\u043E\u043C\u043D\u043E\u0433\u043E \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u0430 \u0444\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0439 \u0441 \u0438\u043D\u0442\u0435\u0440\u043D\u0435\u0442\u0430. \u041F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0432 \u043F\u0430\u0440\u0435 \u0441 \u043C\u0435\u0442\u0430\u043F\u043E\u0438\u0441\u043A\u043E\u0432\u043E\u0439 \u0441\u0438\u0441\u0442\u0435\u043C\u043E\u0439 &quot;searx&quot; \u0438 \u043F\u043E\u0434\u043D\u0438\u043C\u0430\u0435\u0442 \u0441\u043E\u0431\u0441\u0442\u0432\u0435\u043D\u043D\u044B\u0439 \u044D\u043A\u0437\u0435\u043C\u043F\u043B\u044F\u0440 \u044D\u0442\u043E\u0439 \u0441\u0438\u0441\u0442\u0435\u043C\u044B \u0434\u043B\u044F \u043D\u0443\u0436\u0434 \u043F\u043E\u0438\u0441\u043A\u0430 \u0444\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0439. </div><div class="mt-3"> \u041F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B \u043F\u043E\u0438\u0441\u043A\u0430 \u0432\u044B \u043C\u043E\u0436\u0435\u0442\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0438\u0442\u044C \u043D\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0435 \u043F\u043E\u0438\u0441\u043A\u0430 \u043F\u0435\u0440\u0435\u0434 \u0442\u0435\u043C, \u043A\u0430\u043A \u0441\u0434\u0435\u043B\u0430\u0442\u044C \u0437\u0430\u043F\u0440\u043E\u0441. \u041D\u0438\u0436\u0435 \u0441\u0442\u0440\u043E\u043A\u0438 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u0435\u0441\u0442\u044C 4 \u0431\u043B\u043E\u043A\u0430 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043A \u0432 \u043F\u043E\u0440\u044F\u0434\u043A\u0435 \u043F\u0435\u0440\u0435\u0447\u0438\u0441\u043B\u0435\u043D\u0438\u044F: <ul><li>\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0441\u0442\u0440\u0430\u043D\u0438\u0446 \u043F\u043E\u0438\u0441\u043A\u0430 (\u043D\u0430 \u043E\u0434\u043D\u0443 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0443 \u043F\u0440\u0438\u043C\u0435\u0440\u043D\u043E 50-60 \u0444\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0439)</li><li>\u042F\u0437\u044B\u043A \u043F\u043E\u0438\u0441\u043A\u0430</li><li>\u0412\u0440\u0435\u043C\u0435\u043D\u043D\u043E\u0439 \u0438\u043D\u0442\u0435\u0440\u0432\u0430\u043B</li><li>Timeout \u043F\u043E\u0438\u0441\u043A\u043E\u0432\u043E\u0433\u043E \u0437\u0430\u043F\u0440\u043E\u0441\u0430(\u041F\u0440\u0438 \u0431\u043E\u043B\u044C\u0448\u043E\u043C \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u0435 \u0441\u0442\u0440\u0430\u043D\u0438\u0446 \u043C\u043E\u0436\u0435\u0442 \u043F\u043E\u0442\u0440\u0435\u0431\u043E\u0432\u0430\u0442\u044C\u0441\u044F \u0435\u0433\u043E \u0443\u0432\u0435\u043B\u0438\u0447\u0438\u0442\u044C)</li></ul> \u041F\u043E\u0441\u043B\u0435 \u0442\u043E\u0433\u043E, \u043A\u0430\u043A \u0432\u0441\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0435\u043D\u043E, \u043C\u043E\u0436\u043D\u043E \u043F\u0440\u0438\u0441\u0442\u0443\u043F\u0430\u0442\u044C \u043A \u043F\u043E\u0438\u0441\u043A\u0443. \u0412\u0432\u0435\u0434\u044F \u0437\u0430\u043F\u0440\u043E\u0441 \u0438 \u043D\u0430\u0436\u0430\u0432 \u043A\u043D\u043E\u043F\u043A\u0443 \u043F\u043E\u0438\u0441\u043A\u0430, \u043C\u043E\u0436\u043D\u043E \u043F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C \u0441\u0442\u0430\u0442\u0443\u0441 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u0432\u043E \u0432\u043A\u043B\u0430\u0434\u043A\u0435 &quot;\u0418\u0441\u0442\u043E\u0440\u0438\u044F&quot;. \u0422\u0430\u043C \u0436\u0435 \u043C\u043E\u0436\u043D\u043E \u0432\u044B\u043F\u043E\u043B\u043D\u0438\u0442\u044C \u0440\u0430\u0437\u043B\u0438\u0447\u043D\u044B\u0435 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044F \u0441 \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u044B\u043C \u0437\u0430\u043F\u0440\u043E\u0441\u043E\u043C, \u0442\u0430\u043A\u0438\u0435 \u043A\u0430\u043A: <ul><li>\u041F\u0440\u043E\u0441\u043C\u043E\u0442\u0440 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u043E\u0432 \u0437\u0430\u043F\u0440\u043E\u0441\u0430</li><li>\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u0430\u0440\u0445\u0438\u0432\u0430 \u0441 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u0430\u043C\u0438 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u0438 \u043F\u043E\u0441\u043B\u0435\u0434\u0443\u044E\u0449\u0435\u0435 \u0435\u0433\u043E \u0441\u043A\u0430\u0447\u0438\u0432\u0430\u043D\u0438\u0435</li><li>\u0423\u0434\u0430\u043B\u0435\u043D\u0438\u0435 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u0438\u0437 \u0438\u0441\u0442\u043E\u0440\u0438\u0438</li></ul> \u041C\u043E\u0436\u043D\u043E \u0434\u0435\u043B\u0430\u0442\u044C \u0437\u0430\u043F\u0440\u043E\u0441\u044B, \u043D\u0435 \u0434\u043E\u0436\u0438\u0434\u0430\u044F\u0441\u044C \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D\u0438\u044F \u0442\u0435\u043A\u0443\u0449\u0438\u0445 \u0437\u0430\u043F\u0440\u043E\u0441\u043E\u0432, \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430 \u0432\u044B\u043F\u043E\u043B\u043D\u0438\u0442 \u0438\u0445 \u043F\u043E\u0441\u043B\u0435\u0434\u043E\u0432\u0430\u0442\u0435\u043B\u044C\u043D\u043E \u0432 \u043F\u043E\u0440\u044F\u0434\u043A\u0435 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0438\u044F \u0432 \u0441\u043F\u0438\u0441\u043E\u043A. \u041F\u0440\u0438\u044F\u0442\u043D\u043E\u0433\u043E \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u043D\u0438\u044F! </div>', 3);
  var _hoisted_57 = [
    _hoisted_27
  ];
  function render7(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", _hoisted_115, _hoisted_57);
  }

  // src/views/about.vue
  about_default.render = render7;
  about_default.__file = "src/views/about.vue";
  var about_default2 = about_default;
    ...
    routes: [
      {
        path: "/",
        name: "search",
        component: search_default2
      },
      {
        path: "/history",
        name: "history",
        component: history_default2
      },
      {
        path: "/results/:id",
        name: "results",
        component: results_default2
      },
      {
        path: "/about",
        name: "about",
        component: about_default2
      }
    ]
  });
  ...
  var q = /* @__PURE__ */ v(F, [["render", P]]);
  var h2 = "[-+]?[0-9]*.?[0-9]+";
  var L = [
    {
      name: "px",
      regexp: new RegExp(`^${h2}px$`)
    },
    {
      name: "%",
      regexp: new RegExp(`^${h2}%$`)
    },
    /**
     * Fallback option
  ...
  // node_modules/vue3-promise-dialog/dist/vue3-promise-dialog.es.js
  var dialogRef = shallowRef();
  ...
  var PromiseDialog = {
    install: (app2, options) => {
      app2.config.globalProperties.$close = (comp, alternateValue) => {
  ...
  var _hoisted_116 = { key: 0 };
  var _hoisted_28 = { key: 1 };
  var _hoisted_37 = { key: 2 };
  var _hoisted_47 = { key: 3 };
  var _hoisted_58 = { key: 4 };
  var _hoisted_67 = { key: 5 };
  var _hoisted_76 = { key: 6 };
  var _hoisted_86 = { key: 7 };
  var _hoisted_95 = { key: 8 };
  var _hoisted_105 = { key: 9 };
    ...
    setup(__props, { emit: emit2 }) {
      ...
      const onClickHandler = (number) => {
        ...
        if (props.disablePagination)
          return;
        emit2("update:modelValue", number);
      ...
      const totalPages = computed2(() => Math.ceil(props.totalItems / props.itemsPerPage));
      const paginate = computed2(() => {
      ...
      const isRtl = computed2(() => props.dir === "rtl");
      const backButtonIfCondition = computed2(() => {
        if (isRtl.value)
      ...
      const nextButtonIfCondition = computed2(() => {
        if (isRtl.value)
          return !props.hidePrevNextWhenEnds || currentPageRef.value !== 1;
        return !props.hidePrevNextWhenEnds || currentPageRef.value !== totalPages.value;
      });
      const startingBreakPointButtonIfCondition = computed2(() => {
        if (isRtl.value) {
          return paginate.value.pages[0] < totalPages.value - 1;
        }
        return paginate.value.pages[0] >= 3;
      });
      const endingBreakPointButtonIfCondition = computed2(() => {
        if (isRtl.value) {
      ...
      const firstPageButtonIfCondition = computed2(() => {
        if (currentPageRef.value === 1)
          return false;
        return true;
      });
      const lastPageButtonIfCondition = computed2(() => {
      ...
      return (_ctx, _cache) => {
        return openBlock(), createElementBlock("ul", {
          ...
          __props.showEndingButtons && unref(firstPageButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_116, [
          ...
          __props.showJumpButtons && unref(startingBreakPointButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_28, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
          ...
          !__props.hidePrevNext && unref(backButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_37, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
          ...
          __props.showBreakpointButtons && unref(firstButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_47, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
              href: navigationHandler(unref(isRtl) ? unref(totalPages) : 1),
          ...
          __props.showBreakpointButtons && unref(startingBreakPointButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_58, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
          ...
          __props.showBreakpointButtons && unref(endingBreakPointButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_67, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
              href: navigationHandler(__props.disableBreakpointButtons ? unref(currentPageRef) : unref(isRtl) ? unref(currentPageRef) - Math.ceil(__props.maxPagesShown / 2) : unref(currentPageRef) + Math.ceil(__props.maxPagesShown / 2)),
          ...
          __props.showBreakpointButtons && unref(lastButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_76, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
          ...
          !__props.hidePrevNext && unref(nextButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_86, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
              href: navigationHandler(unref(isRtl) ? unref(currentPageRef) - 1 : unref(currentPageRef) + 1),
          ...
          __props.showJumpButtons && unref(endingBreakPointButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_95, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
              href: navigationHandler(unref(isRtl) ? unref(currentPageRef) - Math.ceil(__props.maxPagesShown / 2) : unref(currentPageRef) + Math.ceil(__props.maxPagesShown / 2)),
          ...
          __props.showEndingButtons && unref(lastPageButtonIfCondition) ? (openBlock(), createElementBlock("li", _hoisted_105, [
            (openBlock(), createBlock(resolveDynamicComponent(__props.type === "button" ? "button" : "a"), {
              href: navigationHandler(unref(isRtl) ? 1 : unref(totalPages)),
  ...
  var VueAwesomePaginatePlugin = {
    install: (app2) => {
      app2.component("VueAwesomePaginate", _sfc_main2);
    }
  };
